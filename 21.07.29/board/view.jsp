...
<body>
 ...
 %> 
 <input type="button" value="좋아요" onclick="like()"> <input
				type="button" value="리스트" onclick="location.href='./list.jsp'">
			</td>
		</tr>
	</table>
	<hr />
...
<%		
	...
	%>
		<input type="button" value="삭제"
			onclick="location.href='reply_del.jsp?re_idx=<%=reply.getIdx()%>&b_idx=<%=board.getIdx()%>'">
		<%
		}
			}
		%>
